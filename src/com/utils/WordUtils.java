...
public class WordUtils {
	...
	protected static final WordUtils INSTANCE = new WordUtils();

	public static final WordUtils getInstance() {
		return INSTANCE;
	}
	...
	protected WordUtils(WordUtils original) {
	...
	@Override
	public WordUtils clone() {
		return new WordUtils(this);
	}
	...
	public static String getPlular(String value) {
		WordUtils u = new WordUtils();
		return u.pluralize(value);
	}

	public static String getSingular(String value) {
		WordUtils u = new WordUtils();
		return u.singularize(value);
	}

	public static void main(String[] args) {
		WordUtils u = new WordUtils();
		System.out.println(u.pluralize("c"));
	}
